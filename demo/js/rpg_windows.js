...
if (typeof require != "undefined" && typeof module != "undefined") {
  ...
  var Window = require("./libs/canvas-mock");
...
if (typeof require !== 'undefined' && typeof module != "undefined") {
  module.exports = {
    Window_Base, Window_TitleCommand, Window_SavefileList,
    Window_DebugRange, Window_DebugEdit, Window_Gold,
    Window_ItemList, Window_SkillStatus, Window_SkillList,
    Window_EquipStatus, Window_EquipCommand, Window_EquipSlot,
    Window_EquipItem, Window_Help, Window_Options,
    Window_ShopCommand, Window_ShopBuy, Window_ShopSell,
    Window_ShopNumber, Window_ShopStatus, Window_NameEdit,
    Window_NameInput, Window_ChoiceList, Window_NumberInput,
    Window_Selectable, Window_Command, Window_ScrollText,
    Window_HorzCommand, Window_MenuCommand, Window_MenuStatus,
    Window_MenuActor, Window_ItemCategory, Window_SkillType,
    Window_Status, Window_EventItem, Window_Message,
