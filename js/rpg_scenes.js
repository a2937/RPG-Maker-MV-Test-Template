...
if (typeof require !== 'undefined' && typeof module != "undefined") {
  require("./libs/canvas-mock");
  var { Utils, Bitmap } = require("./rpg_core");
  var { Stage } = require("./libs/pixi");
...
Scene_Name.prototype.onInputOk = function () {
  this._actor.setName(this._editWindow.name().trim());
  this.popScene();
};
...
if (typeof require !== 'undefined' && typeof module != "undefined") {
  module.exports = { Scene_Base, Scene_Boot, Scene_Map, Scene_Title, Scene_Name, Scene_Load, Scene_Debug, Scene_MenuBase };
}
