...
if (typeof require !== 'undefined' && typeof module != "undefined") {
  var { CacheMap, ImageCache, RequestQueue, Utils, Bitmap } = require("./rpg_core");
  var { Game_Temp, Game_System, Game_Screen,
    Game_Timer, Game_Message, Game_Switches, Game_Variables
    , Game_SelfSwitches, Game_Actors, Game_Party,
    Game_Troop, Game_Map, Game_Player } = require("./rpg_objects");
}
...
PluginManager.setup = function (plugins) {
  plugins.forEach(function (plugin) {
    if (plugin.status && !this._scripts.contains(plugin.name)) {
      ...
      if (window.isProduction == undefined || window.isProduction == false) {
        this.loadScript(plugin.name + '.js');
      }
      else {
        this.loadScript(plugin.name + window.jsExtension);
      }
...
if (typeof require !== 'undefined' && typeof module != "undefined") {
  module.exports = {
    StorageManager, PluginManager, AudioManager, SoundManager,
    ImageManager, DataManager, ConfigManager, SceneManager,
    $gameMap, $gameTimer, $gameScreen, $gamePlayer, $gameSystem,
    $dataSystem, $dataMap
  };
}
