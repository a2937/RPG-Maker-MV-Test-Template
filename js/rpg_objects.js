...
if (typeof require !== 'undefined' && typeof module != "undefined") {
  ...
  //var { ImageManager } = require("./rpg_managers");
  var { Utils } = require("./rpg_core");
}
...
Game_CharacterBase.prototype.animationWait = function () {
  return (9 - this.realMoveSpeed()) * 2.2;
};
...
Game_Event.prototype.page = function () {
  if (this._pageIndex == -1 && this.event().pages[-1] == undefined) {
    return { name: {}, note: {}, list: [] };
  }
...
if (typeof require !== 'undefined' && typeof module != "undefined") {
  module.exports = {
    Game_Screen, Game_Map, Game_BattlerBase, Game_CharacterBase,
    Game_System, Game_Player, Game_Interpreter,
    Game_Event, Game_Message, Game_Temp, Game_Timer,
    Game_Switches, Game_Variables, Game_SelfSwitches,
    Game_Actors, Game_Party, Game_Troop, Game_Vehicle,
    Game_Followers, Game_Picture
  };
